...
# -*- coding: utf-8 -*-
#
# aioes documentation build configuration file, created by
...
latex_documents = [
    ('index', 'aioes.tex', 'aioes Documentation',
...
man_pages = [
    ('index', 'aioes', 'aioes Documentation',
     ['Andrew Svetlov'], 1)
]
...
texinfo_documents = [
    ('index', 'aioes', 'aioes Documentation',
     'Andrew Svetlov', 'aioes', 'One line description of project.',
     'Miscellaneous'),
]
